...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post points_url, params: { point: { load_date: @point.load_date, load_file: @point.load_file, note: @point.note, project_id: @point.project_id, status: @point.status } }
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { load_date: @point.load_date, load_file: @point.load_file, note: @point.note, project_id: @point.project_id, status: @point.status } }
