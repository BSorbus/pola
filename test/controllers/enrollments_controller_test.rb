...
class EnrollmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enrollment" do
    assert_difference('Enrollment.count') do
      post enrollments_url, params: { enrollment: { name: @enrollment.name, note: @enrollment.note, user_id: @enrollment.user_id } }
    end
  ...
  test "should update enrollment" do
    patch enrollment_url(@enrollment), params: { enrollment: { name: @enrollment.name, note: @enrollment.note, user_id: @enrollment.user_id } }
