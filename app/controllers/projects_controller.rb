class ProjectsController < ApplicationController
  ...
  private
    ...
    def project_params
      params.require(:project).permit(:number, :registration, :deadline, :note, :project_status_id, :customer_id, accessorizations_attributes: [:id, :project_id, :user_id, :role_id, :_destroy])
    end
